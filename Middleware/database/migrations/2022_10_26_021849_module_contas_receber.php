...
class ModuleContasReceber extends Migration
{
	/**
	 * Run the migrations.
	 *
	...
	public function up()
	{
		Schema::create('module_contas_receber', function (Blueprint $table) {
			...
			$table->decimal('unit_price', 8, 2)->nullable();									#Valor deve ser sempre informado com o separador decimal como ponto.
	...
	{
		Schema::dropIfExists('module_contas_receber');
	}
}
