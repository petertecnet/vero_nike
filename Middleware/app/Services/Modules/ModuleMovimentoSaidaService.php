...
use App\Models\Modules\MovimentoSaida;
use App\Services\Module;

class ModuleMovimentoSaidaService extends Module
{
	public $key				= 'movimento_saida';
	public $name			= 'Notas de Saída (Modelo 55)';
	public $description		= null;
	public $model			= MovimentoSaida::class;
	public $fields			= [
