...
use App\Models\Modules\ContasReceber;
use App\Services\Module;

class ModuleContasReceberService extends Module
{
	public $key				= 'contas_receber';
	public $name			= 'Contas a Receber';
	public $description		= null;
	public $model			= ContasReceber::class;
	public $fields			= [
		[
			'type' => 'string',
	...
	public $layout_MenuIcons	= ['type'=>'fontawesome', 'class'=>'fa fa-money'];
	public $layout_ConfigIcons	= ['type'=>'fontawesome', 'class'=>'fa fa-money'];
