...
use App\Models\Modules\Fornecedor;
use App\Services\Module;

class ModuleFornecedoresService extends Module
{
	public $key				= 'fornecedores';
	public $name			= 'Fornecedores';
	public $description		= null;
	public $model			= Fornecedor::class;
	public $fields			= [
		['type'=>'string', 'field'=>'codigo_cliente', 'name'=>'Código Fornecedor', 'tooltip'=>null, 'placeholder'=>'', 'description'=> null, 'columns'=>12, 'config'=>null, 'showOnList' => true],
		['type'=>'string', 'field'=>'nome_cliente', 'name'=>'Nome Fornecedor', 'tooltip'=>null, 'placeholder'=>'', 'description'=> null, 'columns'=>12, 'config'=>null, 'showOnList' => true],
		...
		['type'=>'string', 'field'=>'grupo_clientes', 'name'=>'Código Grupo de Fornecedores', 'tooltip'=>null, 'placeholder'=>'', 'description'=> null, 'columns'=>12, 'config'=>null, 'showOnList' => false],
		...
		['type'=>'string', 'field'=>'tipo_cliente', 'name'=>'Tipo Fornecedor Com./Energia', 'tooltip'=>null, 'placeholder'=>'', 'description'=> null, 'columns'=>12, 'config'=>null, 'showOnList' => false],
	];
	public $layout_MenuIcons	= ['type'=>'fontawesome', 'class'=>'fa fa-building'];
	public $layout_ConfigIcons	= ['type'=>'fontawesome', 'class'=>'fa fa-building'];
